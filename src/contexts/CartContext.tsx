...
export const CartProvider: FC<CartProviderProps> = ({ children }) => {
  ...
  return (
    <CartContext.Provider value={{ basketItems, setBasketItems, zipsAndCities, setZipsAndCities, fetchZips, removeFromCart, changeToUpsell, calculateTotals, getProductName, onQuantityChange, isProductInBasket, userInfo, setUserInfo }}>
      {children}
